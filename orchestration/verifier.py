...
def verify(source_folders: list[ImapFolder], target_user: str) -> bool:
    """
    Функция оркестр для запуска сверки количества сообщений между серверами

    Args:
        source_folders (list[ImapFolder]): Папки исходного сервера
